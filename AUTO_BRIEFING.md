# AUTO_BRIEFING — 2026-05-12 22:00 Europe/Amsterdam
...
| Metric | Waarde |
|--------|--------|
| Replay buffer entries | 2506 |
| Entries met reward_pct | 20 |
| Training chunks totaal | 0 |
| Training chunks (24u) | 0 |
| Laatste training | — |
| Global step (laatste) | — |
| Avg loss (laatste uur) | None |
| Avg cumulative reward | -4.091693 |
| Policy probs buy/hold/sell | 0.084 / 0.810 / 0.096 |
| Signalen 24u BUY/HOLD/SELL | 22 / 1001 / 1463 |
...
- **ppo_SOL-EUR_models.json** | ts: `20260512T003203Z` | reward_score: `-387.27206` | `artifacts/rl/ppo_SOL-EUR_20260512T003203Z.zip`
...
```
2026-05-12 06:30 UTC     -6.81  ███████████████████████
2026-05-12 10:37 UTC     -4.69  █████████████████████████
...
---
*Gegenereerd: 2026-05-12 22:00 Europe/Amsterdam — `scripts/generate_briefing.py`*
